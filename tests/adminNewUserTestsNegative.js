module.exports = {
  ...
  "Admin register new User(Negative Tests)": function(browser) {
    ...
    browser
      ...
      .assert.containsText(
        ".error-message",
        "2 validation errors detected: Value at 'username' failed to satisfy constraint: Member must satisfy regular expression pattern: [\\p{L}\\p{M}\\p{S}\\p{N}\\p{P}]+; Value at 'username' failed to satisfy constraint: Member must have length greater than or equal to 1"
      )
      .end();
  }
};
