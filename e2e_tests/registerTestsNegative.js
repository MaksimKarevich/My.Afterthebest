module.exports = {
  ...
  'Register Test Negative': function (browser) {
    ...
    browser
          ...
          .assert.containsText('.error-message', 'This is a required field and must be valid e-mail address')
          ...
          .assert.attributeContains('.btn.btn-success', 'class', 'disabled')
          .assert.elementPresent('.error-message')
          .assert.containsText('.error-message', 'Phone must contain at least 6 and no more than 50 numbers')
          ...
          .clearValue('input[placeholder="Phone number"]')
          .setValue('input[placeholder="Phone number"]', '111111111111111111111111111111111111111111111111111')
          .assert.attributeContains('.btn.btn-success', 'class', 'disabled')
          .assert.elementPresent('.error-message')
          .assert.containsText('.error-message', 'Phone must contain at least 6 and no more than 50 numbers')

          .clearValue('input[placeholder="Phone number"]')
          .setValue('input[placeholder="Phone number"]', '11111111111111111111111111111111111111111111111111')
          .assert.elementPresent('.btn.btn-success')
          .assert.elementNotPresent('.error-message')
          ...
          .assert.attributeContains('.btn.btn-success', 'class', 'disabled')
          .assert.elementPresent('.error-message')
          .assert.containsText('.error-message', 'Address must contain at least 5 and no more than 256 letters')
          ...
          .clearValue('input[placeholder="Address"]')
          .setValue('input[placeholder="Address"]', '')
          .assert.attributeContains('.btn.btn-success', 'class', 'disabled')
          .assert.elementPresent('.error-message')
          .assert.containsText('.error-message', 'Address must contain at least 5 and no more than 256 letters')

          .clearValue('input[placeholder="Address"]')
          .setValue('input[placeholder="Address"]', '')
          .assert.elementPresent('.btn.btn-success')
          .assert.elementNotPresent('.error-message')
