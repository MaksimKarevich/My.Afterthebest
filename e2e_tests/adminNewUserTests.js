module.exports = {
    ...
    'Admin register new User': function (browser) {
        ...
        browser
            ...
            .waitForElementVisible('.success-message', 3000, false, function () {}, 'Account is created')
            .assert.containsText('.success-message', 'User successfully created.', 'User successfully created.')
            //Displayed information about registered user
            .waitForElementVisible('.badge-warning', 3000, false, function () {}, 'The Account is not activate')
            .assert.containsText('.badge-warning', 'FORCE_CHANGE_PASSWORD', 'User status is: FORCE_CHANGE_PASSWORD')
            .assert.containsText('.badge-success', 'Enabled', 'Account status is: Enabled')
            //Deactivate account
            .click('.dropdown-toggle.btn-primary')
            .waitForElementVisible('.dropdown-menu.show',2000, false, function () {}, 'Dropdown menu is displayed')
            .click('.dropdown-menu.show :nth-child(1) a.dropdown-item')
            .waitForElementVisible('div.mini-toastr__notification.-success', 2000, false, function () {}, 'Account is Deactivated')
            .assert.containsText('div.mini-toastr__notification.-success', 'Profile successfully deactivated!', 'Profile successfully deactivated!')
            .assert.containsText('.badge-danger', 'Disabled', 'Account status is: Disabled')
            //Delete account
            .click('.dropdown-toggle.btn-primary')
            .click('.dropdown-menu.show :nth-child(2) a.dropdown-item')
            .waitForElementVisible('div.mini-toastr__notification.-success', 1000, false, function () {}, 'Account is Deleted')
            .assert.containsText('div.mini-toastr__notification.-success', 'Profile successfully deleted! You will be redirected shortly.', 'Profile successfully deleted! You will be redirected shortly.')
            .waitForElementVisible(".btn.btn-primary", 1000, false, function () {}, 'New user button is displayed')
            .assert.urlContains('/users', 'The Users page is open')
        .end()
    },
};
